This folder contains the implementation of Multivariate Linear Regression and Multilayer Perceptron emulators for time-series regression in the northern Adriatic Sea.
