...
cmems_path = (
    f"{base_path}/inference 2022/predictors/Trieste/"
    "cmems_7PCs_fulldomain_Trieste_2022.txt"
)

tide_path = (
    f"{base_path}/inference 2022/predictors/Trieste/"
    "tide_Trieste_2022.txt"
)

mslp_path = (
    f"{base_path}/inference 2022/predictors/Trieste/"
    "ERA5mslp_7PCs_fulldomain_Trieste_2022.txt"
)

u10_path = (
    f"{base_path}/inference 2022/predictors/Trieste/"
    "ERA5stressX_7PCs_fulldomain_Trieste_2022.txt"
)

v10_path = (
    f"{base_path}/inference 2022/predictors/Trieste/"
    "ERA5stressY_7PCs_fulldomain_Trieste_2022.txt"
)
...
output_dir = (
    ...
    "aligned_predictors_Trieste_2022"
)
