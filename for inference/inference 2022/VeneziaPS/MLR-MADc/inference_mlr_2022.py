...
MODEL_DIR = (
    ...
    r"\Results april 2026\VeneziaPS\MLR-MADc"
)
...
raw_output_file = os.path.join(
    ...
    "mlrModel_Run2_2022_inference_RAW.txt"
)
...
lp_output_file = os.path.join(
    ...
    "mlrModel_Run2_2022_inference_LP13h.txt"
)
...
checkpoint_path = os.path.join(
    MODEL_DIR,
    "mlrModel_Run2_checkpoint.pth"
)

preprocessing_path = os.path.join(
    MODEL_DIR,
    "mlrModel_Run2_preprocessing.pkl"
)
