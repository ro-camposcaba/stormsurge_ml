...
sta = load('meteoDTNLP13h_TG_Trieste_2022.txt');
...
cop = load('meteoDTNLP13h_cmemsforecast_Trieste_2022-2023.txt');

% ML model 1 - MLR
addpath('C:\Users\Rodrigo\Desktop\Rodrigo\02 - Research fellow\01 - Storm surge ML downscaling\surge_ml\tests\inference 2022\Trieste\MLR-MADc')
shy = load('mlrModel_Run13_2022_inference_RAW.txt');

% ML model 2 - LSTMh
addpath('C:\Users\Rodrigo\Desktop\Rodrigo\02 - Research fellow\01 - Storm surge ML downscaling\surge_ml\tests\inference 2022\Trieste\LSTMh-MADc')
shy2 = load('lstmHybridModel_Run9_2022_inference_RAW.txt');

% ML model 2 - MLP
% addpath('C:\Users\Rodrigo\Desktop\Rodrigo\02 - Research fellow\01 - Storm surge ML downscaling\Experiments_v6_v2\surge-ml_v2 - sliding-window\downscaling 2022\Trieste\MLP-MADc')
% shy2 = load('mlpModelLP13h_Trieste_2022_checkpoint13_v2026.txt');
...
title('Trieste, 2022', 'FontName', 'Century Gothic');
...
legend({'Tide gauge: Trieste','Copernicus forecast',...
...
set(gcf, 'Color', 'w');
%export_fig('Timeseries_2022_traintestTG_Trieste_MLR_LSTMh_HQ.png','-m2.5')
...
% Apply Century Gothic font to all text elements
set(gca, 'FontName', 'Century Gothic');  % Axes labels and ticks
title('Trieste (November, 2022)', 'FontName', 'Century Gothic');
...
addpath('C:\Users\Rodrigo\Desktop\Rodrigo\Matlab functions\altmany-export_fig-3.40.0.0')
set(gcf, 'Color', 'w');
%export_fig('Timeseries_november2022_Trieste_MLR_LSTMh.png','-m2.5')
%export_fig('Timeseries_november2022_Trieste_MLR_MLP.png','-m2.5')
